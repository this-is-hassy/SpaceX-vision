                ...
                {ServiceData.map((data, index) => {
                  return (
                    <div
                      ...
                      className="min-h-[180px] flex flex-col justify-center items-center rounded-xl gap-2 bg-gray-950 backdrop-blur-sm  text-white text-center text-2xl py-8 px-3 w-full lg:w-[300px] mx-auto"
                    >
                      {data.icon}
                      <h1>{data.title}</h1>
                      <p>{data.content}</p>
